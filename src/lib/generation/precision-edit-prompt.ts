import { classifyLocalEdit, localEditInstruction } from "./local-edit-intent.ts";
...
export function withPrecisionEditPreamble(
  prompt: string,
  mustPreserve: string[] = [],
...
${localEditInstruction(classifyLocalEdit(requestedChange))}
