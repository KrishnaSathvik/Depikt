...
const PAGE_TITLE = "Prompt Recipes — One question, one citable prompt | Depikt";
const PAGE_DESCRIPTION =
  "A growing index of one-question, one-prompt recipes for GPT Image 2. Each recipe answers a specific question (\"What's a prompt for a 3-panel storyboard?\") with a single copy-paste prompt.";
const PAGE_URL = absoluteUrl("/recipes");
    ...
    <div className="min-h-screen bg-[color:var(--bg)]">
      ...
      <main className="mx-auto max-w-[1200px] px-6 lg:px-12 py-16">
        <header className="max-w-[60ch]">
          <p className="eyebrow">Prompt Recipes</p>
          ...
          <p className="mt-4 text-body-lg text-[color:var(--text-secondary)]">
            Every recipe answers one specific question with a single copy-paste prompt for GPT
        ...
        <aside className="mt-16 rounded-md border border-[color:var(--accent)] bg-[color:var(--accent)] px-8 py-8 sm:px-10 sm:py-10 text-center">
          ...
          <p className="mt-2 text-body-sm text-white/70">
            The generator writes a recipe-style prompt from any rough idea in seconds.
          </p>
